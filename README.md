...
Katya@ubuntu:~$ export GITHUB_TOKEN=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
...
Katya@ubuntu:~/Ekaterina06-choi/workspace$ \curl -sSL https://get.rvm.io
#!/usr/bin/env bash
...
Katya@ubuntu:~/Ekaterina06-choi/workspace$ cd projects/lab04
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04$ git remote remove origin
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04$ git remote add origin https://github.com/${GITHUB_USERNAME}/lab04
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04$ cat > .travis.yml <<EOF
language: cpp
EOF
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04$ cat >> .travis.yml <<EOF
...
addons:
  apt:
    ...
    packages:
      ...
      - cmake-data
EOF
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04$ git add .travis.yml
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04$ git add README.md
fatal: pathspec 'README.md' did not match any files
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04$ git add README.md
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04$ git commit -m"added CI"
[main 271b2d8] added CI
 1 file changed, 170 insertions(+)
 create mode 100644 README.md
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04$ git push origin main
Username for 'https://github.com': Ekaterina06-choi
Password for 'https://Ekaterina06-choi@github.com': 
To https://github.com/Ekaterina06-choi/lab04
 ! [rejected]        main -> main (fetch first)
error: failed to push some refs to 'https://github.com/Ekaterina06-choi/lab04'
hint: Updates were rejected because the remote contains work that you do not
hint: have locally. This is usually caused by another repository pushing to
hint: the same ref. If you want to integrate the remote changes, use
hint: 'git pull' before pushing again.
hint: See the 'Note about fast-forwards' in 'git push --help' for details.
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04$ git push -f origin main
Username for 'https://github.com': Ekaterina06-choi
Password for 'https://Ekaterina06-choi@github.com': 
...
Writing objects: 100% (98/98), 59.35 KiB | 11.87 MiB/s, done.
...
remote:        https://github.com/Ekaterina06-choi/lab04/security/secret-scanning/unblock-secret/2w2g9pfjoG26DWDzxXjqJLp8f7E
remote:     
remote: 
remote: 
To https://github.com/Ekaterina06-choi/lab04
...
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04$ 
